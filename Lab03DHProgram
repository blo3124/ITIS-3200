...
def xor_crypt(data, prng):
    ...
    stream_bytes = prng.generate(len(data))
    return bytes([d ^ k for d, k in zip(data, stream_bytes)])
...
def main():
    ...
    message = b"Test 1 2 3, does it work fine?" # Put in your test message here
